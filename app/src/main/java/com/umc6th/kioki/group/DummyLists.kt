...
object DummyLists {
    val notices = listOf(
        NoticeEntity("키오스크 신규 추가 목록 안내", "2024.08.22"),
        NoticeEntity("글씨 크기 적용 관련 안내", "2024.07.23"),
        NoticeEntity("키오스크 평가 관련 안내", "2024.07.10"),
        NoticeEntity("통합 서비스 이용약관 계정 안내", "2024.06.22"),
        NoticeEntity("앱 최소 지원 버전 변경 안내", "2024.06.05"),
    )
    val reivews = listOf(
